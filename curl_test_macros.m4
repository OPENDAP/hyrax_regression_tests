...
m4_define([AT_CURL_RESPONSE_TEST], [dnl
    ...
    AS_IF([test -n "$baselines" -a x$baselines = xyes],
        [
        AT_CHECK([sed "s+@DAP_SERVICE@+$DAP_SERVICE+g" $input | curl --netrc-file $CURL_NETRC_FILE --netrc-optional -c ../cookies_file -b ../cookies_file -L -K -], [0], [stdout])
...
m4_define([AT_CURL_DAP2_DATA_RESPONSE_TEST],  [dnl
    ...
    AS_IF([test -n "$baselines" -a x$baselines = xyes],
        [
        AT_CHECK([sed "s+@DAP_SERVICE@+$DAP_SERVICE+g" $input | curl --netrc-file $CURL_NETRC_FILE --netrc-optional -c ../cookies_file -b ../cookies_file -L -K - | getdap -Ms -], [0], [stdout])
        PATCH_SERVER_NAME([stdout])
        AT_CHECK([mv stdout $baseline.tmp])
        ],
        [
...
m4_define([AT_CURL_DAP4_DATA_RESPONSE_TEST],  [dnl
    ...
    AS_IF([test -n "$baselines" -a x$baselines = xyes],
        [
        AT_CHECK([sed "s+@DAP_SERVICE@+$DAP_SERVICE+g" $input | curl --netrc-file $CURL_NETRC_FILE --netrc-optional -c ../cookies_file -b ../cookies_file -L -K - | getdap4 -D -M -s -], [0], [stdout])
        PATCH_SERVER_NAME([stdout])
        AT_CHECK([mv stdout $baseline.tmp])
        ],
        [
...
m4_define([AT_CURL_RESPONSE_AND_HTTP_HEADER_TEST], [dnl
    ...
    AS_IF([test -n "$baselines" -a x$baselines = xyes],
        [
        AT_CHECK([sed "s+@DAP_SERVICE@+$DAP_SERVICE+g" $input | curl --netrc-file $CURL_NETRC_FILE --netrc-optional -c ../cookies_file -b ../cookies_file -L -D $http_header -K -], [0], [stdout])
...
m4_define([AT_CURL_HTTP_HEADER_TEST], [dnl
    ...
    AS_IF([test -n "$baselines" -a x$baselines = xyes],
        [
        AT_CHECK([sed "s+@DAP_SERVICE@+$DAP_SERVICE+g" $input | curl --netrc-file $CURL_NETRC_FILE --netrc-optional -c ../cookies_file -b ../cookies_file -L -D $http_header -K - > /dev/null], [0], [ignore])
